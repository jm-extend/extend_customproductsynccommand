...
namespace Extend\CustomProductSyncCommand\Console\Command;

use Extend\Warranty\Helper\Api\Data as DataHelper;
use Extend\Warranty\Model\ProductSyncFlag;
use Extend\CustomProductSyncCommand\Model\ProductSyncProcess;
...
class SyncProducts extends Command
{
    ...
    public function doExecute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->productSyncProcess->execute($defaultBatchSize, $force);
